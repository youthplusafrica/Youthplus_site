      ...
      <div className="mx-auto max-w-8xl px-6 py-12">
        ...
        <article className="w-full">
          <h3 className="text-xl md:text-2xl font-semibold">
            <span className="text-[var(--yplus-primary,#d0a328)]">YOUTH UNEMPLOYMENT</span>: A GLOBAL PERSPECTIVE
          </h3>
          ...
          <ul className="mt-5 grid grid-cols-1 md:grid-cols-4 gap-3 text-white/90">
            <li className="rounded-xl border border-white/15 p-4">
              <span className="block text-3xl font-extrabold text-[var(--yplus-primary,#d0a328)]">
                732M
              </span>
        ...
        <article className="mt-10">
          <h3 className="text-xl md:text-2xl font-semibold">
            <span className="text-[var(--yplus-primary,#d0a328)]">YOUTH UNEMPLOYMENT</span>: A KENYAN PERSPECTIVE
          </h3>
